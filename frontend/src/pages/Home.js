  ...
  const startVoiceSearch = () => {
    ...
    recog.onresult = (e) => {
      ...
      if (finalTranscript) {
        ...
        handleSearch(null, finalTranscript);
    ...
    recog.onerror = (e) => {
      ...
      let msg = text.voiceError || 'Voice search error.';
      if (e.error === 'no-speech') {
        msg = text.noSpeech || 'No speech detected.';
      } else if (e.error === 'not-allowed') {
        msg = text.micBlocked || 'Microphone access denied.';
      } else if (e.error === 'audio-capture') {
        msg = text.micError || 'Microphone not found.';
      } else if (e.error === 'network') {
        msg = text.networkError || 'Network error.';
      }
      setError(msg);
    };
